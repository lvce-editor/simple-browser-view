...
- Native link and editing menus, clipboard actions, Inspect Element, and browser DevTools.
...
The runner starts a fresh Electron process and isolated XDG profile for each case. Local HTTP fixtures avoid external website dependencies; suggestion tests intercept the provider in Electron. Native menu tests construct the real menu and invoke its captured action without leaving an operating-system popup open.
